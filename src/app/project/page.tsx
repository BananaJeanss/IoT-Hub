      ...
      <div id="project-cont2">
        <div id="project-header">
          ...
          <div id="project-lower-header">
            <h1>Project Name</h1>
            <p>
              Project description goes here. Lorem ipsum dolor sit amet, consectetur adipiscing
              elit. In nec lacinia velit. Praesent nec ligula neque. Suspendisse semper nunc quis
              tristique convallis. Vivamus sed sem quis ipsum ullamcorper tincidunt eget quis
              sapien.
            </p>
            <div id="tags">
              <p>🤖 AI</p>
        ...
        <div id="project-contents">
          <div id="project-contents-left">
            <h2>Description</h2>
            <p>
              readme.md yadayada images and stuff wow wow wow lorem ipsum wooooooow dolor sit amet,
              consectetur adipiscing elit. In nec lacinia velit. Praesent nec ligula neque.
              Suspendisse semper nunc quis tristique convallis. Vivamus sed sem quis ipsum
